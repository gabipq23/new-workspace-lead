  ...
  const ComunicacaoContent = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Programe eventos rapidamente verificando a disponibilidade de colegas
          de trabalho ou sobrepondo agendas.
        </p>
      </div>
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Videochamadas criptografadas e eficientes com interface rápida e leve,
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Crie suas próprias comunidades para interagir e compartilhar todas as
          informações com suas equipes.
        </p>
      </div>
    </div>
  );
  ...
  const ColaboracaoContent = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Mais facilidade para colaborar e compartilhar informações com recursos
          ágeis.
        </p>
      </div>
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Pesquisas e questionários personalizados com fácil acesso e análise de
          resultados.
        </p>
      </div>
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Crie facilmente páginas web sem programação para sua equipe ou empresa
          e publique-o rapidamente.
        </p>
      </div>
  ...
  const ControleContent = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
      ...
      <div className="flex flex-col items-start">
        ...
        <h3 className="text-lg font-medium text-gray-800 mb-2">Cloud Search</h3>
        <p className="text-gray-600 text-sm leading-relaxed">
  ...
  const SinergiaContent = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Reúna todas as ferramentas de aprendizagem e gerencie várias turmas em
          uma plataforma central e colaborativa.
        </p>
      </div>
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Crie seu aplicativo de negócios sem conhecimento de código capturando
