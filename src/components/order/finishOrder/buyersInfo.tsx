...
export default function InfoComprador(basicInfo: any) {
  return (
    <div className="flex flex-col items-start rounded-[26px] w-full px-0 p-4 pt-0 gap-8 ">
      <div className="flex flex-col bg-white px-6 text-neutral-800 gap-2 w-full  rounded-lg min-h-[120px] p-4">
